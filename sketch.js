...
function setup(){
    ...
    umbrella = new Umbrella(200,900);
     
   cloud1=createSprite(180,0,20,20);
   cloud2=createSprite(550,0,20,20);
   cloud3=createSprite(920,0,20,20);
   //cloud1.velocityX=-1;
   //cloud2.velocityX=-1;
   //cloud3.velocityX=-1;
    //create drops
...
function draw(){
    ...
    if(frameCount%1 === 0){
       drops.push(new Drops(random(30,1000),-100,8));
      }
